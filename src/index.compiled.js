...
var Card = function Card(_ref) {
  ...
  var matchedIDs = (0, _reactRedux.useSelector)(_boardSlice.selectVisibleIDs);
  var dispatch = (0, _reactRedux.useDispatch)(_boardSlice.selectMatchedIDs); // flip card action
